...
//import 'AudiosAudioPlayer.dart';


class GeneralizeClassListAshaarDetails extends StatefulWidget {
  ...
  GeneralizeClassListAshaarDetails(this.index, this.id, this.download, this.name, this.status, this.date,
  ...
  @override
  GeneralizeClassListAshaarDetailsState createState() => GeneralizeClassListAshaarDetailsState();
}
class GeneralizeClassListAshaarDetailsState extends State<GeneralizeClassListAshaarDetails> {
